...
export default class MaterialIcons {
  ...
  private static readonly _iconMap: Record<string, ui.IconData> = {
    ...
    "block": this.block,
    "block_flipped": this.block_flipped,
    ...
    "cloudy_snowing": this.cloudy_snowing,
    "co2": this.co2,
    ...
    "drive_file_move_outline": this.drive_file_move_outline,
    ...
    "filter_list_alt": this.filter_list_alt,
    ...
    "no_meals_ouline": this.no_meals_ouline,
    ...
    "pie_chart_outlined": this.pie_chart_outlined,
    "pin": this.pin,
    ...
    "wb_twighlight": this.wb_twighlight,
    ...
    "workspaces_filled": this.workspaces_filled,
    "workspaces_outline": this.workspaces_outline,
