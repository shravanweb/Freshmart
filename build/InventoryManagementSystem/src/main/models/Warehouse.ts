...
export default class Warehouse extends DBObject {
  ...
  public setName(val: string): void {
    ...
    this.updateD3EChanges(Warehouse._NAME, this._name);
  ...
  public setOrganization(val: Organization): void {
    ...
    this.updateD3EChanges(Warehouse._ORGANIZATION, this._organization);
  ...
  public get(field: number): any {
    switch (field) {
      case Warehouse._NAME: {
        return this._name;
      }

      case Warehouse._ORGANIZATION: {
        return this._organization;
      }
      default: {
        return null;
...
*/
  ...
  public deepClone(clearId = true): Warehouse {
  ...
  public deepCloneIntoObj(dbObj: DBObject, ctx: CloneContext): void {
    let obj: Warehouse = dbObj as Warehouse;
