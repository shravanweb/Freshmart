...
export default class AllPurchaseOrdersRequest extends DBObject {
  ...
  public get(field: number): any {
    switch (field) {
      case AllPurchaseOrdersRequest._ORGANIZATION: {
        return this._organization;
      }
      default: {
        return null;
...
*/
  ...
  public deepClone(clearId = true): AllPurchaseOrdersRequest {
  ...
  public deepCloneIntoObj(dbObj: DBObject, ctx: CloneContext): void {
    let obj: AllPurchaseOrdersRequest = dbObj as AllPurchaseOrdersRequest;
