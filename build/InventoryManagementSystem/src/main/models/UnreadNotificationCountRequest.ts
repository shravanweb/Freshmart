...
export default class UnreadNotificationCountRequest extends DBObject {
  ...
  public setUser(val: User): void {
    ...
    this.updateD3EChanges(UnreadNotificationCountRequest._USER, this._user);
  ...
  public get(field: number): any {
    switch (field) {
      case UnreadNotificationCountRequest._ORGANIZATION: {
        return this._organization;
      }

      case UnreadNotificationCountRequest._USER: {
        return this._user;
      }
      default: {
        return null;
...
*/
  ...
  public deepClone(clearId = true): UnreadNotificationCountRequest {
  ...
  public deepCloneIntoObj(dbObj: DBObject, ctx: CloneContext): void {
    let obj: UnreadNotificationCountRequest =
      dbObj as UnreadNotificationCountRequest;
