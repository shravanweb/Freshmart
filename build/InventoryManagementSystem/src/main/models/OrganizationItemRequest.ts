...
export default class OrganizationItemRequest extends DBObject {
  ...
  public get(field: number): any {
    switch (field) {
      case OrganizationItemRequest._ORGANIZATION: {
        return this._organization;
      }
      default: {
        return null;
...
*/
  ...
  public deepClone(clearId = true): OrganizationItemRequest {
  ...
  public deepCloneIntoObj(dbObj: DBObject, ctx: CloneContext): void {
    let obj: OrganizationItemRequest = dbObj as OrganizationItemRequest;
