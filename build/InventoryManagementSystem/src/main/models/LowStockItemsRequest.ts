...
export default class LowStockItemsRequest extends DBObject {
  ...
  public get(field: number): any {
    switch (field) {
      case LowStockItemsRequest._ORGANIZATION: {
        return this._organization;
      }
      default: {
        return null;
...
*/
  ...
  public deepClone(clearId = true): LowStockItemsRequest {
  ...
  public deepCloneIntoObj(dbObj: DBObject, ctx: CloneContext): void {
    let obj: LowStockItemsRequest = dbObj as LowStockItemsRequest;
