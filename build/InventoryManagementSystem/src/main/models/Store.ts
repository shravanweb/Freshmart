...
export default class Store extends DBObject {
  ...
  public setName(val: string): void {
    ...
    this.updateD3EChanges(Store._NAME, this._name);
  ...
  public setOrganization(val: Organization): void {
    ...
    this.updateD3EChanges(Store._ORGANIZATION, this._organization);
...
*/
  ...
  public deepClone(clearId = true): Store {
