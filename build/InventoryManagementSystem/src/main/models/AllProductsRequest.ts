...
export default class AllProductsRequest extends DBObject {
  ...
  public setOrganization(val: Organization): void {
    ...
    this.updateD3EChanges(AllProductsRequest._ORGANIZATION, this._organization);
  ...
  public get(field: number): any {
    switch (field) {
      case AllProductsRequest._ORGANIZATION: {
        return this._organization;
      }
      default: {
        return null;
...
*/
  ...
  public deepClone(clearId = true): AllProductsRequest {
  ...
  public deepCloneIntoObj(dbObj: DBObject, ctx: CloneContext): void {
    let obj: AllProductsRequest = dbObj as AllProductsRequest;
