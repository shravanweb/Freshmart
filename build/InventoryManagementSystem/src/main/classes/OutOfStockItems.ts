...
export default class OutOfStockItems extends DBObject {
  ...
  public setStatus(val: ResultStatus): void {
    ...
    this.updateD3EChanges(OutOfStockItems._STATUS, this._status.index);
  ...
  public setErrors(val: Array<string>): void {
    ...
    if (!this.d3eChanges.contains(OutOfStockItems._ERRORS)) {
      let _old: Array<string> = Array.from(this._errors);

      this.updateD3EChanges(OutOfStockItems._ERRORS, _old);
    }
  ...
  public setCount(val: number): void {
    ...
    this.updateD3EChanges(OutOfStockItems._COUNT, this._count);
  ...
  public setItems(val: Array<WarehouseStock>): void {
    ...
    if (!this.d3eChanges.contains(OutOfStockItems._ITEMS)) {
      let _old: Array<WarehouseStock> = Array.from(this._items);

      this.updateD3EChanges(OutOfStockItems._ITEMS, _old);
    }
  ...
  public equals(other: any): boolean {
    return (
      this === other ||
      (other instanceof OutOfStockItems &&
