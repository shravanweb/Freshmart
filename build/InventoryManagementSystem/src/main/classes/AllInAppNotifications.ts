...
export default class AllInAppNotifications extends DBObject {
  ...
  public setStatus(val: ResultStatus): void {
    ...
    this.updateD3EChanges(AllInAppNotifications._STATUS, this._status.index);
  ...
  public setErrors(val: Array<string>): void {
    ...
    if (!this.d3eChanges.contains(AllInAppNotifications._ERRORS)) {
      let _old: Array<string> = Array.from(this._errors);

      this.updateD3EChanges(AllInAppNotifications._ERRORS, _old);
    }
  ...
  public setCount(val: number): void {
    ...
    this.updateD3EChanges(AllInAppNotifications._COUNT, this._count);
  ...
  public setItems(val: Array<InAppNotification>): void {
    ...
    if (!this.d3eChanges.contains(AllInAppNotifications._ITEMS)) {
      let _old: Array<InAppNotification> = Array.from(this._items);

      this.updateD3EChanges(AllInAppNotifications._ITEMS, _old);
    }
  ...
  public set(field: number, value: any): void {
    switch (field) {
      case AllInAppNotifications._STATUS: {
        this.setStatus(ResultStatus.values[value as number]);
        break;
      }

      case AllInAppNotifications._ERRORS: {
        this.setErrors((value as Array<any>).cast<string>().toList());
        break;
      }

      case AllInAppNotifications._COUNT: {
        this.setCount(value as number);
        break;
      }

      case AllInAppNotifications._ITEMS: {
  ...
  public equals(other: any): boolean {
    return (
      this === other ||
      (other instanceof AllInAppNotifications &&
