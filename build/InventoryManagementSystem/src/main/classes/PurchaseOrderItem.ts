...
export default class PurchaseOrderItem extends DBObject {
  ...
  public setStatus(val: ResultStatus): void {
    ...
    this.updateD3EChanges(PurchaseOrderItem._STATUS, this._status.index);
  ...
  public setErrors(val: Array<string>): void {
    ...
    if (!this.d3eChanges.contains(PurchaseOrderItem._ERRORS)) {
      let _old: Array<string> = Array.from(this._errors);

      this.updateD3EChanges(PurchaseOrderItem._ERRORS, _old);
    }
  ...
  public setItems(val: Array<PurchaseOrder>): void {
    ...
    if (!this.d3eChanges.contains(PurchaseOrderItem._ITEMS)) {
      let _old: Array<PurchaseOrder> = Array.from(this._items);

      this.updateD3EChanges(PurchaseOrderItem._ITEMS, _old);
    }
