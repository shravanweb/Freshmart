...
public class DashboardMetricsChangeTracker implements Cancellable {
  ...
  private class DashboardMetricsInput {
    private TypeAndId organizationRef;
    private Organization organization;

    public DashboardMetricsInput(DashboardMetricsRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"DashboardMetrics\\\" is required, but got value null.");
      }
    }
  ...
  private DashboardMetrics root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private DashboardMetricsInput inputs;
  private Field field;

  public DashboardMetricsChangeTracker(
  ...
  public void init(OutObject out, DashboardMetrics initialData, DashboardMetricsRequest inputs) {
    {
    ...
    this.inputs = new DashboardMetricsInput(inputs);
  ...
  private void storeInitialData(DashboardMetrics initialData) {
