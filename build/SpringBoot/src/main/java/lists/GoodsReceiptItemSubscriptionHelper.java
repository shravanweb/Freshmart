...
public class GoodsReceiptItemSubscriptionHelper
  ...
  private Field field;
  private GoodsReceiptItemRequest inputs;

  @Async
  public void handleContextStart(DataQueryDataChange event) {
    updateData(event);
    try {
      event.data = goodsReceiptItemImpl.getAsJson(field, event.nativeData);
  ...
  private void loadInitialData() {
    ...
    change.nativeData = goodsReceiptItemImpl.getNativeResult(this.inputs);
  ...
  public Flowable<DataQueryDataChange> subscribe(Field field, GoodsReceiptItemRequest inputs) {
    {
