...
public class StockTransferItemSubscriptionHelper
  ...
  private Field field;
  private StockTransferItemRequest inputs;

  @Async
  public void handleContextStart(DataQueryDataChange event) {
    updateData(event);
    try {
      event.data = stockTransferItemImpl.getAsJson(field, event.nativeData);
  ...
  private void loadInitialData() {
    ...
    change.nativeData = stockTransferItemImpl.getNativeResult(this.inputs);
  ...
  public Flowable<DataQueryDataChange> subscribe(Field field, StockTransferItemRequest inputs) {
    {
