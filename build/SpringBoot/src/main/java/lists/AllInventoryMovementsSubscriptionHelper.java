...
public class AllInventoryMovementsSubscriptionHelper
  ...
  private Field field;
  private AllInventoryMovementsRequest inputs;

  @Async
  public void handleContextStart(DataQueryDataChange event) {
    updateData(event);
    try {
      event.data = allInventoryMovementsImpl.getAsJson(field, event.nativeData, event.count);
  ...
  private void loadInitialData() {
    ...
    change.nativeData = allInventoryMovementsImpl.getNativeResult(this.inputs);
  ...
  public Flowable<DataQueryDataChange> subscribe(Field field, AllInventoryMovementsRequest inputs) {
    {
