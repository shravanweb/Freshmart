...
public class AllProductsChangeTracker implements Cancellable {
  ...
  private class AllProductsInput {
    private TypeAndId organizationRef;
    private Organization organization;

    public AllProductsInput(AllProductsRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"AllProducts\\\" is required, but got value null.");
      }
    }
  ...
  public void init(OutObject out, AllProducts initialData, AllProductsRequest inputs) {
    {
    ...
    this.inputs = new AllProductsInput(inputs);
  ...
  private void storeInitialData(AllProducts initialData) {
