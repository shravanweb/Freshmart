...
public class OutOfStockItemsChangeTracker implements Cancellable {
  ...
  private class OutOfStockItemsInput {
    private TypeAndId organizationRef;
    private Organization organization;

    public OutOfStockItemsInput(OutOfStockItemsRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"OutOfStockItems\\\" is required, but got value null.");
      }
    }
  ...
  private OutOfStockItems root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private OutOfStockItemsInput inputs;
  private Field field;

  public OutOfStockItemsChangeTracker(
  ...
  public void init(OutObject out, OutOfStockItems initialData, OutOfStockItemsRequest inputs) {
    {
    ...
    this.inputs = new OutOfStockItemsInput(inputs);
  ...
  private void storeInitialData(OutOfStockItems initialData) {
