...
public class PurchaseOrderItemSubscriptionHelper
  ...
  private Field field;
  private PurchaseOrderItemRequest inputs;

  @Async
  public void handleContextStart(DataQueryDataChange event) {
    updateData(event);
    try {
      event.data = purchaseOrderItemImpl.getAsJson(field, event.nativeData);
  ...
  private void loadInitialData() {
    ...
    change.nativeData = purchaseOrderItemImpl.getNativeResult(this.inputs);
  ...
  public Flowable<DataQueryDataChange> subscribe(Field field, PurchaseOrderItemRequest inputs) {
    {
