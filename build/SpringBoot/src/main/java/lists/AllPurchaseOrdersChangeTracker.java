...
public class AllPurchaseOrdersChangeTracker implements Cancellable {
  ...
  private class AllPurchaseOrdersInput {
    private TypeAndId organizationRef;
    private Organization organization;

    public AllPurchaseOrdersInput(AllPurchaseOrdersRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"AllPurchaseOrders\\\" is required, but got value null.");
      }
    }
  ...
  private AllPurchaseOrders root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private AllPurchaseOrdersInput inputs;
  private Field field;

  public AllPurchaseOrdersChangeTracker(
  ...
  public void init(OutObject out, AllPurchaseOrders initialData, AllPurchaseOrdersRequest inputs) {
    {
    ...
    this.inputs = new AllPurchaseOrdersInput(inputs);
  ...
  private void storeInitialData(AllPurchaseOrders initialData) {
