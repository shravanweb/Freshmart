...
public class MovementReportRowsChangeTracker implements Cancellable {
  ...
  private class MovementReportRowsInput {
    ...
    public MovementReportRowsInput(MovementReportRowsRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"MovementReportRows\\\" is required, but got value null.");
      }
  ...
  private MovementReportRows root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private MovementReportRowsInput inputs;
  private Field field;

  public MovementReportRowsChangeTracker(
  ...
  public void init(
      OutObject out, MovementReportRows initialData, MovementReportRowsRequest inputs) {
    {
    ...
    this.inputs = new MovementReportRowsInput(inputs);
  ...
  private void storeInitialData(MovementReportRows initialData) {
