...
public class AllSalesOrdersChangeTracker implements Cancellable {
  ...
  private class AllSalesOrdersInput {
    private TypeAndId organizationRef;
    private Organization organization;

    public AllSalesOrdersInput(AllSalesOrdersRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"AllSalesOrders\\\" is required, but got value null.");
      }
    }
  ...
  private AllSalesOrders root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private AllSalesOrdersInput inputs;
  private Field field;

  public AllSalesOrdersChangeTracker(
  ...
  public void init(OutObject out, AllSalesOrders initialData, AllSalesOrdersRequest inputs) {
    {
    ...
    this.inputs = new AllSalesOrdersInput(inputs);
  ...
  private void storeInitialData(AllSalesOrders initialData) {
