...
public class ProductsByCategoryChangeTracker implements Cancellable {
  ...
  private class ProductsByCategoryInput {
    private TypeAndId organizationRef;
    private Organization organization;
    private TypeAndId categoryRef;
    private ProductCategory category;

    public ProductsByCategoryInput(ProductsByCategoryRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"ProductsByCategory\\\" is required, but got value null.");
      }
      this.categoryRef = TypeAndId.from(_req.getCategory());
      if (_req.getCategory() == null) {
        Log.info(
            "WARNING: Input \\\"category\\\" in \\\"ProductsByCategory\\\" is required, but got value null.");
      }
    }
  ...
  private ProductsByCategory root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private ProductsByCategoryInput inputs;
  private Field field;

  public ProductsByCategoryChangeTracker(
  ...
  public void init(
      OutObject out, ProductsByCategory initialData, ProductsByCategoryRequest inputs) {
    {
    ...
    this.inputs = new ProductsByCategoryInput(inputs);
  ...
  private void storeInitialData(ProductsByCategory initialData) {
