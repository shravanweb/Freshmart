...
public class AllInventoryMovementsChangeTracker implements Cancellable {
  ...
  private class AllInventoryMovementsInput {
    private TypeAndId organizationRef;
    private Organization organization;

    public AllInventoryMovementsInput(AllInventoryMovementsRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"AllInventoryMovements\\\" is required, but got value null.");
      }
    }
  ...
  private AllInventoryMovements root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private AllInventoryMovementsInput inputs;
  private Field field;

  public AllInventoryMovementsChangeTracker(
  ...
  public void init(
      OutObject out, AllInventoryMovements initialData, AllInventoryMovementsRequest inputs) {
    {
    ...
    this.inputs = new AllInventoryMovementsInput(inputs);
  ...
  private void storeInitialData(AllInventoryMovements initialData) {
