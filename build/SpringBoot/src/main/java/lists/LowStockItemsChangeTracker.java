...
public class LowStockItemsChangeTracker implements Cancellable {
  ...
  private class LowStockItemsInput {
    private TypeAndId organizationRef;
    private Organization organization;

    public LowStockItemsInput(LowStockItemsRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"LowStockItems\\\" is required, but got value null.");
      }
    }
  ...
  private LowStockItems root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private LowStockItemsInput inputs;
  private Field field;

  public LowStockItemsChangeTracker(
  ...
  public void init(OutObject out, LowStockItems initialData, LowStockItemsRequest inputs) {
    {
    ...
    this.inputs = new LowStockItemsInput(inputs);
  ...
  private void storeInitialData(LowStockItems initialData) {
