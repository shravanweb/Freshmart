...
public class AllWarehousesChangeTracker implements Cancellable {
  ...
  private class AllWarehousesInput {
    private TypeAndId organizationRef;
    private Organization organization;

    public AllWarehousesInput(AllWarehousesRequest _req) {
      this.organizationRef = TypeAndId.from(_req.getOrganization());
      if (_req.getOrganization() == null) {
        Log.info(
            "WARNING: Input \\\"organization\\\" in \\\"AllWarehouses\\\" is required, but got value null.");
      }
    }
  ...
  private AllWarehouses root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private AllWarehousesInput inputs;
  private Field field;

  public AllWarehousesChangeTracker(
  ...
  public void init(OutObject out, AllWarehouses initialData, AllWarehousesRequest inputs) {
    {
    ...
    this.inputs = new AllWarehousesInput(inputs);
  ...
  private void storeInitialData(AllWarehouses initialData) {
