...
public class AllOrganizationsChangeTracker implements Cancellable {
  ...
  public AllOrganizationsChangeTracker(
  ...
  public void init(OutObject out, AllOrganizations initialData) {
    {
  ...
  private void storeInitialData(AllOrganizations initialData) {
  ...
  private void addSubscriptions() {
    ...
    Disposable baseSubscribe =
        tracker.listen(
            ...
            null,
            (obj, old, type) ->
                applyOrganization(((Organization) obj), ((Organization) obj), type));
  ...
  private boolean createPathChangeChange(Organization model, Organization old) {
  ...
  private void moveItems(Organization model, TypeAndId data, String OrderByValue0) {
    // Find old index
