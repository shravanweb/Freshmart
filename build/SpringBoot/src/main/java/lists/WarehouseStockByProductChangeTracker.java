...
public class WarehouseStockByProductChangeTracker implements Cancellable {
  ...
  private class WarehouseStockByProductInput {
    private TypeAndId productRef;
    private Product product;

    public WarehouseStockByProductInput(WarehouseStockByProductRequest _req) {
      this.productRef = TypeAndId.from(_req.getProduct());
      if (_req.getProduct() == null) {
        Log.info(
            "WARNING: Input \\\"product\\\" in \\\"WarehouseStockByProduct\\\" is required, but got value null.");
      }
    }
  ...
  private WarehouseStockByProduct root;
  private List<OrderBy> orderBy = ListExt.List();
  private DataChangeTracker tracker;
  private ClientSession clientSession;
  private List<Disposable> disposables = ListExt.List();
  private WarehouseStockByProductInput inputs;
  private Field field;

  public WarehouseStockByProductChangeTracker(
  ...
  public void init(
      OutObject out, WarehouseStockByProduct initialData, WarehouseStockByProductRequest inputs) {
    {
    ...
    this.inputs = new WarehouseStockByProductInput(inputs);
  ...
  private void storeInitialData(WarehouseStockByProduct initialData) {
