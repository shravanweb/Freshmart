...
public class InventoryMovementsByDateRangeSubscriptionHelper
  ...
  private Field field;
  private InventoryMovementsByDateRangeRequest inputs;
  ...
  public void handleContextStart(DataQueryDataChange event) {
    ...
    try {
      event.data =
          inventoryMovementsByDateRangeImpl.getAsJson(field, event.nativeData, event.count);
  ...
  private void loadInitialData() {
    ...
    change.nativeData = inventoryMovementsByDateRangeImpl.getNativeResult(this.inputs);
  ...
  public Flowable<DataQueryDataChange> subscribe(
      Field field, InventoryMovementsByDateRangeRequest inputs) {
    {
  ...
  private List<NativeObj> createInventoryMovementData(InventoryMovement inventoryMovement) {
    ...
    row.set(2, inventoryMovement.getId());
    row.setId(2);
    data.add(row);
    return data;
  }
