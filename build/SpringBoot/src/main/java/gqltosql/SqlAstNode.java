...
public class SqlAstNode {
	...
	public JSONArray executeQuery(IEntityManager em, Set<Long> ids, Map<Long, SqlRow> byId) throws Exception {
		if (ids.isEmpty()) {
		...
		Log.displaySql(getPath(), sql, ids);
	...
	public void executeSubQuery(IEntityManager em, Function<String, List<SqlRow>> listSupplier) throws Exception {
