...
public class SalesOrderItem extends DBObject {
  ...
  public SalesOrderItem(List<String> errors, List<SalesOrder> items, ResultStatus status) {
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.SalesOrderItem;
  }
