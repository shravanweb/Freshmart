...
public class PurchaseOrderItem extends DBObject {
  ...
  public PurchaseOrderItem(List<String> errors, List<PurchaseOrder> items, ResultStatus status) {
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.PurchaseOrderItem;
  }
