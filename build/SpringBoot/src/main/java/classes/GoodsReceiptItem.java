...
public class GoodsReceiptItem extends DBObject {
  ...
  public GoodsReceiptItem(List<String> errors, List<GoodsReceipt> items, ResultStatus status) {
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.GoodsReceiptItem;
  }
