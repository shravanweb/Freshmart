...
public class AllUserProfiles extends DBObject {
  ...
  public AllUserProfiles() {}

  public AllUserProfiles(
      long count, List<String> errors, List<UserProfile> items, ResultStatus status) {
    this.count = count;
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.AllUserProfiles;
  }
