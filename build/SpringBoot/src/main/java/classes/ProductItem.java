...
public class ProductItem extends DBObject {
  ...
  public ProductItem(List<String> errors, List<Product> items, ResultStatus status) {
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.ProductItem;
  }
