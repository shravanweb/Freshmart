...
public class AllOrganizations extends DBObject {
  ...
  public AllOrganizations(
      long count, List<String> errors, List<Organization> items, ResultStatus status) {
    this.count = count;
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.AllOrganizations;
  }
