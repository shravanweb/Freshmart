...
public class AllStockTransfers extends DBObject {
  ...
  public AllStockTransfers() {}

  public AllStockTransfers(
      long count, List<String> errors, List<StockTransfer> items, ResultStatus status) {
    this.count = count;
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.AllStockTransfers;
  }
