...
public class AllProducts extends DBObject {
  ...
  public AllProducts(long count, List<String> errors, List<Product> items, ResultStatus status) {
    this.count = count;
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.AllProducts;
  }
