...
public class ProductsByCategory extends DBObject {
  ...
  public ProductsByCategory(
      long count, List<String> errors, List<Product> items, ResultStatus status) {
    this.count = count;
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.ProductsByCategory;
  }
