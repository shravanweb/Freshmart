...
public class SupplierItem extends DBObject {
  ...
  public SupplierItem(List<String> errors, List<Vendor> items, ResultStatus status) {
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.SupplierItem;
  }
