...
public class DashboardMetrics extends DBObject {
  ...
  public DashboardMetrics(List<String> errors, List<WarehouseStock> items, ResultStatus status) {
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.DashboardMetrics;
  }
