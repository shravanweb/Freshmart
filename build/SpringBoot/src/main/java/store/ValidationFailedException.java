...
public class ValidationFailedException extends RuntimeException {
	...
	public static ValidationFailedException fromValidationContext(EntityValidationContext ctx) {
		...
		ValidationFailedException e = new ValidationFailedException(Stream
				.concat(ctx.getErrors().stream(), ctx.getThrowableErrors().stream()).collect(Collectors.toList()));
	...
	public ValidationFailedException(Throwable cause) {
		super(cause);
		this.errors = ListExt.asList("Internal Server Error");
	}
