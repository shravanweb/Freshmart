...
public class DoubleExt {
    ...
    public static long compareTo(double one, double other) {
	...
	public static long toInt(double l) {
		return (long) l;
	}

	public static String toStringAsFixed(double num, long l) {
