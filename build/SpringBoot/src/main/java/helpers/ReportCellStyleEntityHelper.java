...
@org.springframework.stereotype.Service("ReportCellStyle")
public class ReportCellStyleEntityHelper<T extends ReportCellStyle> implements EntityHelper<T> {
  ...
  public ReportCellStyle newInstance() {
