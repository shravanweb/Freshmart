...
@org.springframework.stereotype.Service("AllStoresRequest")
public class AllStoresRequestEntityHelper<T extends AllStoresRequest> implements EntityHelper<T> {
  ...
  public AllStoresRequest newInstance() {
