...
@org.springframework.stereotype.Service("ReportPropertyFilter")
public class ReportPropertyFilterEntityHelper<T extends ReportPropertyFilter>
    extends ReportFilterEntityHelper<T> {
  public ReportPropertyFilter newInstance() {
