...
@org.springframework.stereotype.Service("AllDevicesRequest")
public class AllDevicesRequestEntityHelper<T extends AllDevicesRequest> implements EntityHelper<T> {
  ...
  public AllDevicesRequest newInstance() {
