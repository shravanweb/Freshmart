...
@org.springframework.stereotype.Service("ReportProperty")
public class ReportPropertyEntityHelper<T extends ReportProperty> implements EntityHelper<T> {
  ...
  public ReportProperty newInstance() {
