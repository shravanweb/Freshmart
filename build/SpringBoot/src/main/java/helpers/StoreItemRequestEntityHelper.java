...
@org.springframework.stereotype.Service("StoreItemRequest")
public class StoreItemRequestEntityHelper<T extends StoreItemRequest> implements EntityHelper<T> {
  ...
  public StoreItemRequest newInstance() {
