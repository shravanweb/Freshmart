...
@org.springframework.stereotype.Service("ReportDataSection")
public class ReportDataSectionEntityHelper<T extends ReportDataSection> implements EntityHelper<T> {
  ...
  public ReportDataSection newInstance() {
