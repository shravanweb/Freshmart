...
@org.springframework.stereotype.Service("UserLoginRecord")
public class UserLoginRecordEntityHelper<T extends UserLoginRecord> implements EntityHelper<T> {
  ...
  public UserLoginRecord newInstance() {
  ...
  public T getById(long id) {
    return id == 0l ? null : ((T) userLoginRecordRepository.getOne(id));
  }
