...
@org.springframework.stereotype.Service("SalesOrdersByStoreRequest")
public class SalesOrdersByStoreRequestEntityHelper<T extends SalesOrdersByStoreRequest>
  ...
  public SalesOrdersByStoreRequest newInstance() {
