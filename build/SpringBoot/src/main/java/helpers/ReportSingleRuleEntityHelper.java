...
@org.springframework.stereotype.Service("ReportSingleRule")
public class ReportSingleRuleEntityHelper<T extends ReportSingleRule>
    extends ReportRuleEntityHelper<T> {
  public ReportSingleRule newInstance() {
