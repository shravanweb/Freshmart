...
@org.springframework.stereotype.Service("ReportField")
public class ReportFieldEntityHelper<T extends ReportField> implements EntityHelper<T> {
  ...
  public ReportField newInstance() {
